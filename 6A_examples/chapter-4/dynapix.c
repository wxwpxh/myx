...
int main (int argc, char *argv[])
{
	...
	(void) XmVaCreateSimplePulldownMenu (menubar, "help_menu", 2, help_cb,        
...
{
	/* This also pops down the XmDialogShell parent of the File Selection Box */
...
void load_pixmap (Widget dialog, XtPointer client_data, XtPointer call_data)
{
	...
	if (pixmap == XmUNSPECIFIED_PIXMAP)        
		...
		XtVaSetValues (label, XmNlabelType, XmPIXMAP, XmNlabelPixmap, pixmap, NULL);    
	}
}
...
*/
void change_color (Widget    widget,      /* menu item that was selected */
                   XtPointer client_data, /* the index into the menu */
		   XtPointer call_data)   /* unused */
{
