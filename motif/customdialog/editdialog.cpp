...
{ 
 Widget dia_shell,form,age_label,name_label,name_text,addr_label,addr_text; 
 ...
 XmStringFree(bnt_text);
  ...
  bnt_text=XmStringCreateLtoR((char *)"RED",XmSTRING_DEFAULT_CHARSET);
  i=0;
  XtSetArg(args[i],XmNlabelString,bnt_text);i++;   
  tog1=XtCreateManagedWidget("tog1",xmToggleButtonWidgetClass
                          ,toggle_box,args,i);
  XmStringFree(bnt_text);
  XtAddCallback(tog1,XmNvalueChangedCallback,set_color_callbk,(char *)"red");

  bnt_text=XmStringCreateLtoR((char *)"BLUE",XmSTRING_DEFAULT_CHARSET);
  i=0;
  XtSetArg(args[i],XmNlabelString,bnt_text);i++;   
  tog2=XtCreateManagedWidget("tog2",xmToggleButtonWidgetClass
                          ,toggle_box,args,i);
  XmStringFree(bnt_text);
  XtAddCallback(tog2,XmNvalueChangedCallback,set_color_callbk,(char *)"blue");

  bnt_text=XmStringCreateLtoR((char *)"YELLOW",XmSTRING_DEFAULT_CHARSET);
  i=0;
  XtSetArg(args[i],XmNlabelString,bnt_text);i++;   
  tog3=XtCreateManagedWidget("toggle",xmToggleButtonWidgetClass
                          ,toggle_box,args,i);
  XmStringFree(bnt_text);
  XtAddCallback(tog3,XmNvalueChangedCallback,set_color_callbk,(char *)"yellow");
  ...
  XtSetArg(args[i],XmNleftOffset,10);i++;   
  addr_text=XmCreateTextField(form,(char *)"adr_text",args,i);  
  ...
  i=0;   
  XtSetArg(args[i],XmNtopAttachment,XmATTACH_WIDGET);i++;
  XtSetArg(args[i],XmNtopWidget,scrolled_text);i++; 
